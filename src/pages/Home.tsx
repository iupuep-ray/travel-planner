...
const Home = () => {
  ...
  if (loading) {
    return (
      <>
        ...
        <div
          className="pb-8 pt-[calc(var(--app-safe-top)+2rem)] px-4 mb-4 rounded-b-[40px] relative z-10"
  ...
  return (
    <>
      {/* Weather Header */}
      <div
        className="text-white pb-8 pt-[calc(var(--app-safe-top)+2rem)] px-4 mb-4 rounded-b-[40px] relative z-10"
        style={{ backgroundColor: '#78A153' }}
      >
        {/* Weather Content */}
